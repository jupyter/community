...
- Should this team take on the Distinguished Contributors process?
    ...
    - Chris: Wants to see groups like JCB make funding requests to manage capacity. What's the point of Jupyter Foundation if not to pay for this kind of stuff?
        - Matt: What's the process to ask for money?
            - No formal process except for CFP. **Set up a dedicated repository github.com/jupyter/council for communicating with EC. Created 2 issue templates, one is a [funding request template](https://github.com/jupyter/council/issues/new?template=resource-request.yml). It's not a formal process, but you can get the conversation started this way**.
